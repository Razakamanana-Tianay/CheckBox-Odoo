...
4. **scaffold_script.** What cwd and environment variables does it get? Can it locate its case directory? If not, fixtures are copied per case by `build_eval_fixtures.py`.
